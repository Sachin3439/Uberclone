...
const ConfirmRidePanel = (props) => {
  return (
    <div>
        ...
        <h2 onClick={() => { props.setconfirmRidePanel(false) }} className="w-[95%] absolute left-[48%] top-1">
          ...
          <div className='flex  flex-col justify-between items-center gap-2'>
            ...
            <button onClick={()=>{props.setvehicleFound(true),props.setconfirmRidePanel(false)}} className=' mt-5 w-full h-9 bg-green-600 text-center text-white font-bold rounded-lg'>Confirm</button>
          </div>
